...
class OverLoCK(nn.Module):
    ...
    def forward_sub_features(self, x, ctx):
        ...
        return (x_focus_16, x_focus_32, ctx_cls)

    def forward_features(self, x):
        
        x_4,x_8 = self.forward_pre_features(x)
        x_16, ctx = self.forward_base_features(x_8)
        x_focus_16, x_focus_32, ctx_cls = self.forward_sub_features(x_16, ctx)

        return (x_4, x_8, x_focus_16, x_focus_32, ctx_cls)
