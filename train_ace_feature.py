...
from ace_trainer_feature import TrainerACE
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_buffer_size', type=int, default=20000000,
                        help='number of patches in the training buffer')
    
    parser.add_argument('--onebuffer', type=int, default=5000000,
